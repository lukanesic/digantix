...
export default function TeamCarousel() {
  return (
    <section id="team-section" className="py-24 bg-white overflow-hidden">
      <div className="mx-auto w-[85%] px-6 lg:px-8" style={{ maxWidth: '1500px' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {teamMembers.map((member) => (
            ...
            >
              ...
              <div className="relative w-full aspect-[390/480] rounded-[5px] overflow-hidden mb-4">
                <Image
                  src={member.image}
                  alt={member.name}
                  fill
