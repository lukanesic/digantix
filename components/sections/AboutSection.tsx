...
export default function AboutSection({
  ...
  return (
    <section className="relative py-20 px-6 lg:px-8 bg-white">
      <div className="mx-auto w-[90%]" style={{ maxWidth: '1700px' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col justify-start space-y-12">
            {/* Title */}
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-medium text-black leading-tight tracking-tight" style={{ letterSpacing: '-0.025em' }}>
              {title}
            </h2>
